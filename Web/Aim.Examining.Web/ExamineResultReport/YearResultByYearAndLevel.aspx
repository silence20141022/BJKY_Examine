<%@ Page Title="考核结果2" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="YearResultByYearAndLevel.aspx.cs" Inherits="Aim.Examining.Web.YearResultByYearAndLevel" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        var level = unescape($.getQueryString({ ID: "level" }));
