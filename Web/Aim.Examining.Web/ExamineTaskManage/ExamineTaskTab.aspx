<%@ Page Title="考核任务" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="ExamineTaskTab.aspx.cs" Inherits="Aim.Examining.Web.ExamineTaskManage.ExamineTaskTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "ExamineTaskGroup.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "ExamineTaskGroup.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
