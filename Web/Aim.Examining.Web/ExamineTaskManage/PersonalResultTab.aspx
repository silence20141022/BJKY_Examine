<%@ Page Title="考核结果" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="PersonalResultTab.aspx.cs" Inherits="Aim.Examining.Web.ExamineTaskManage.PersonalResultTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "PersonalResult.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "PersonalResult.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
