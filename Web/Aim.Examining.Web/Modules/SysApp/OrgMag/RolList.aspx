<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="RolList.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.OrgMag.RolList" %>
        ...
        var roleTypeTlBar = new Ext.ux.AimToolbar({
            ...
            var schBar = new Ext.ux.AimSchPanel({
                ...
                items: [{ layout: 'form', unstyled: true, columnWidth: .33,
                    items: [new Ext.app.AimSearchField({ fieldLabel: '角色名', anchor: '90%', name: 'Name', store: store, aimgrp: "usrgrp", qryopts: "{ mode: 'Like', field: 'Name' }" })]
                }, { layout: 'form', unstyled: true, columnWidth: .33,
                    items: [new Ext.app.AimSearchField({ fieldLabel: '编码', anchor: '90%', name: 'Code', store: store, aimgrp: "usrgrp", qryopts: "{ mode: 'Like', field: 'Code' }" })]
                }, { layout: 'form', unstyled: true, columnWidth: .33,
                    items: [rolTypeSchField]
}]
                });
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyHolder" runat="server">
    <div id="header" style="display:none;"><h1>角色列表</h1></div>
</asp:Content>
