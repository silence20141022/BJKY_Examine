<%@ Page Title="属性编辑" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="true" CodeBehind="OrgStructureEdit.aspx.cs" Inherits="Aim.Examining.Web.OrgStructureEdit" %>
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data">
                        <select id="Status" name="Status" aimctrl='select' enum="DataTypeEnum" class="validate[required]"
                            style="width: 150px">
                        </select>
                    </td>
                    <td class="aim-ui-td-caption">
