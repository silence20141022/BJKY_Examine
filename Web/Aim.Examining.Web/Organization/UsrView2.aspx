<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="UsrView2.aspx.cs" Inherits="Aim.Examining.Web.UsrView2" %>
            ...
            var tlBar = new Ext.ux.AimToolbar({
                ...
                }, '->',
                {
                    ...
                    handler: function() {
                        ...
                        ExtBatchOperate('sendmail', recs, null, null, function(rtn) {
                            AimDlg.show("发送成功!无效地址有:" + rtn.data.Count + "个");
                            Ext.getBody().unmask();
                        });
                    }
                }, '-', { text: '查询:' }, new Ext.app.AimSearchField({ store: store, pgbar: pgBar, schbutton: true, qryopts: "{ mode: 'Like', field: 'Name'}" })]
            });
