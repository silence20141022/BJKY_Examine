<%@ Page Title="启动考核" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="True" CodeBehind="DeptExamineStep6.aspx.cs" Inherits="Aim.Examining.Web.DeptExamineStep6" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Launch() {
            $(":button").attr("disabled", "disabled");
            $.ajaxExecSync("launch", { id: id }, function(rtn) {
                if (rtn.data.Id) {
                    alert("启动打分考核成功！");
                }
            });
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyHolder" runat="server">
    ...
    <div style="text-align: center">
        <input type="button" value="启动打分考核" style="width: 120px" onclick="Launch()" /></div>
</asp:Content>
