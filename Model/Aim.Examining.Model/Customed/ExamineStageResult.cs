...
namespace Aim.Examining.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class ExamineStageResult
    {
        #region 成员变量
        ...
        {
			ExamineStageResult[] tents = ExamineStageResult.FindAll(Expression.In("Id", args));

			foreach (ExamineStageResult tent in tents)
			{
				tent.DoDelete();
			}
        }
