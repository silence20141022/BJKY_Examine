...
namespace Aim.Examining.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class PersonFirstIndicator
    {
        #region 成员变量
        ...
        {
			PersonFirstIndicator[] tents = PersonFirstIndicator.FindAll(Expression.In("Id", args));

			foreach (PersonFirstIndicator tent in tents)
			{
				tent.DoDelete();
			}
        }
