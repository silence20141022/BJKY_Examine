...
namespace Aim.Examining.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class CustomIndicatorOpinion
    {
        #region 成员变量
        ...
        {
			CustomIndicatorOpinion[] tents = CustomIndicatorOpinion.FindAll(Expression.In("Id", args));

			foreach (CustomIndicatorOpinion tent in tents)
			{
				tent.DoDelete();
			}
        }
