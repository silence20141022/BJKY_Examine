...
namespace Aim.Examining.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class PersonSecondIndicator
    {
        #region 成员变量
        ...
        {
			PersonSecondIndicator[] tents = PersonSecondIndicator.FindAll(Expression.In("Id", args));

			foreach (PersonSecondIndicator tent in tents)
			{
				tent.DoDelete();
			}
        }
